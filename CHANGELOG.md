...
- **Environment variable allowlist**: sandbox now filters env vars by default; `sandbox.env.allow` in `~/.claude/settings.json` or `.claude/settings.json` controls what is passed through. Default allowlist: `PATH`, `HOME`, `TMPDIR`, `TMP`, `TEMP`, `USER`, `USERNAME`, `LANG`, `LC_ALL`, `LC_CTYPE`, `NODE_PATH`, `SHELL`
...
- **Full VitePress documentation site** at <https://joeblackwaslike.github.io/mcp-exec/>: Guide, User Manual, Developer, and Reference sections covering installation, configuration, runtimes, CLI, security, and case studies
...
[1.0.0]: https://github.com/joeblackwaslike/mcp-exec/compare/v0.3.0...v1.0.0
[0.3.0]: https://github.com/joeblackwaslike/mcp-exec/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/joeblackwaslike/mcp-exec/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/joeblackwaslike/mcp-exec/releases/tag/v0.1.0
